...
public class GlobalExceptionHandler {
    ...
    /**
     * Handles AuthorNotFoundException (404).
     */
    ...
    /**
     * Handles ExternalApiException (502).
     */
    ...
    /**
     * Handles HttpClientErrorException (e.g. 400, 401, 403).
     */
    ...
    public ResponseEntity<Error> handleHttpClientErrorException(HttpClientErrorException ex, WebRequest request) {
        ...
        String message = ex.getStatusCode().value() == 401 ?
    ...
    /**
     * Handles HttpServerErrorException (e.g. 500, 503).
     */
    ...
    public ResponseEntity<Error> handleHttpServerErrorException(HttpServerErrorException ex, WebRequest request) {
        ...
        Error error = Error.builder()
                ...
                .message("SerpAPI isn't available at the moment, please try again later")
                .error(ex.getMessage())
                .path(request.getDescription(false).replace("uri=", ""))
                .build();
    ...
    /**
     * Handles uncaught exceptions (500).
     */
